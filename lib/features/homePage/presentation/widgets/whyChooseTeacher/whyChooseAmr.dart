...
class WhyChooseTeacher extends StatefulWidget {
  WhyChooseTeacher({super.key,required this.name});
String name;
  @override
  State<WhyChooseTeacher> createState() => _WhyChooseTeacherState();
}

class _WhyChooseTeacherState extends State<WhyChooseTeacher>
